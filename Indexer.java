...
public class Indexer {
	...
	public void genforwardIndex(String filename) throws IOException {
	...
	public void invertIndex(String index_filename, String lexicon_filename) throws IOException {
	...
	private void loadJSONFiles(String index_filename, String lexicon_filename) throws IOException {
		Gson gson = new Gson();
